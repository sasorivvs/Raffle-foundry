...
```
git clone https://github.com/sasorivvs/Raffle-foundry
cd Raffle-foundry
forge build
```
...
```
cast send <RAFFLE_CONTRACT_ADDRESS> "enterRaffle()" --value 1ether --private-key <PRIVATE_KEY> --rpc-url $SEPOLIA_RPC_URL
```
